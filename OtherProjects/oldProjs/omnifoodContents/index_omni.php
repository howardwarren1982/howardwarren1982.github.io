...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Omnifood is a premium food delivery service wtith the mission to bring...">
    <meta charset="utf-8">
    <link
    rel="stylesheet"
    href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/4.1.1/animate.min.css"/>
    <link rel="stylesheet" type="text/css"  href="resources/css/style_omni.css">
  ...
  <body>
      ...
      <nav>
        <div class="row">
          ...
          <ul class="main-nav js--main-nav">
            <li> <a href="#stick-nav-trigger">Food delivery </a> </li>
    ...
    <section class="section-featres js--section-featres js-js--wp-1-trigger" id="stick-nav-trigger">
      <div class="row">
    ...
    <section class="section-steps js-js--wp-2-trigger" id="how-it-works">
      <div class="row">
      ...
      <div class="row">
        ...
        <a href="#" class="btn-app"> <img src="resources/img/download-app-android.png" alt="App Playstore button"> </a>
      </div>
    </div>
    </section>
...
<div class="city-card-list row">

        <div class="cities-card">
          <div class="city-card-img">
            <img src="resources/img/lisbon-3.jpg" alt="the city of Lisbon">
          </div>
        ...
        <div class="cities-card">
          <div class="city-card-img">
            <img src="resources/img/san-francisco.jpg" alt="the city of San Francisco">
          </div>
          <div class="city-card-info">
            <h3>San Francisco</h3>
            <div class="city-feature">
    ...
    <section class="section-testimonials">
      ...
      <div class="row testimonial-templete">
    ...
    <section class="section-plans js--section-plans js-js--wp-3-trigger" id="sign-up">
        <div class="row">
          <h2>Start eating healthy today</h2>
        </div>

        <div class="row">
          <div class="plans-templete">
            ...
            <div class="plan-box">
              ...
              <div>
                <ul>
                  ...
                  <li style="margin-bottom: 10px;" ><ion-icon class="icon-small" name="checkmark-outline"></ion-icon>Free delivery</li>
                </ul>
              </div>
              <div>
                <a href="#" class="btn btn-ghost">Sign up</a>
      ...
      <div class="row">
        ...
        <div class="col span-1-of-2">
          <ul class="social-links">
            ...
            <li> <a href="#"><ion-icon class="twitter" name="cloud-download-outline"></ion-icon> </a> </li>
    ...
    <script src="vendors/js/inview.min.js"></script>
    <script src="resources/js/script_omi.js"></script>
  </body>
